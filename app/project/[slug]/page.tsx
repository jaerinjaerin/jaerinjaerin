      ...
      <div className='container mx-auto px-4 py-[clamp(40px,7.8vw,80px)]'>
        ...
        {(project.problem || project.solution) && (
          <div className='flex flex-col lg:flex-row gap-6 mb-6'>
            {project.problem && (
              <section className='border border-red-300/60 rounded-2xl px-6 py-4 flex gap-3'>
            ...
            {project.solution && (
              <section className='border border-primary/60 rounded-2xl px-6 py-4 flex gap-3'>
